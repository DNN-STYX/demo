...
function mission(){
	...
	if [ "$i" -eq 1 ]; then
		...
		python -u traditional_training.py "mnist_MLP" 20 > ../../result/mnist_MLP_tra.txt
		cp -r ./model ../../model/mnist_MLP/tra_model
		#==================================
		cd ../../
		cd mnist_MLP/STYX/
		python -u mutation_training.py "mnist_MLP" 20 	 > ../../result/mnist_MLP_mut.txt
		cp -r ./model ../../model/mnist_MLP/mut_model
		#==================================
		cd ../../
		cd mnist_MLP/adversarial_training/
		python -u adversarial_training.py "mnist_MLP" 20 > ../../result/mnist_MLP_adv.txt
		...
		python -u traditional_training.py "mnist_CNN" 20 > ../../result/mnist_CNN_tra.txt
		cp -r ./model ../../model/mnist_CNN/tra_model
		#==================================
		cd ../../
		cd mnist_CNN/STYX/
		python -u mutation_training.py "mnist_CNN" 20	 > ../../result/mnist_CNN_mut.txt
		cp -r ./model ../../model/mnist_CNN/mut_model
		#==================================
		cd ../../
		cd mnist_CNN/adversarial_training/
		python -u adversarial_training.py "mnist_CNN"  20 > ../../result/mnist_CNN_adv.txt
		...
		python -u traditional_training.py "fmnist_MLP" 20 > ../../result/fmnist_MLP_tra.txt
		cp -r ./model ../../model/fmnist_MLP/tra_model
		#==================================
		cd ../../
		cd fmnist_MLP/STYX/
		python -u mutation_training.py "fmnist_MLP" 20	  > ../../result/fmnist_MLP_mut.txt
		cp -r ./model ../../model/fmnist_MLP/mut_model
		#==================================
		cd ../../
		cd fmnist_MLP/adversarial_training/
		python -u adversarial_training.py "fmnist_MLP" 20 > ../../result/fmnist_MLP_adv.txt
		...
		python -u traditional_training.py "fmnist_CNN" 20 > ../../result/fmnist_CNN_tra.txt
		cp -r ./model ../../model/fmnist_CNN/tra_model
		#==================================
		cd ../../
		cd fmnist_CNN/STYX/
		python -u mutation_training.py "fmnist_CNN" 20 	  > ../../result/fmnist_CNN_mut.txt
		cp -r ./model ../../model/fmnist_CNN/mut_model
		#==================================
		cd ../../
		cd fmnist_CNN/adversarial_training/
		python -u adversarial_training.py "fmnist_CNN" 20 > ../../result/fmnist_CNN_adv.txt
		...
		cd ../../
		cd cifar10_CNN/STYX/
		python -u mutation_training.py "cifar10_CNN" 25    > ../../result/cifar10_CNN_mut.txt
