...
function mission(){
	...
	if [ "$i" -eq 1 ]; then
		...
		python -u main_evaluation.py "[DeepFool]" 	    > ../../evaluation_result/mnist_MLP_evaluation.txt 
		...
		python -u main_evaluation.py "[DeepFool]" 	    > ../../evaluation_result/mnist_CNN_evaluation.txt 
		...
		python -u main_evaluation.py "[DeepFool]" 	    > ../../evaluation_result/fmnist_MLP_evaluation.txt 
		...
		python -u main_evaluation.py "[DeepFool]" 	    > ../../evaluation_result/fmnist_CNN_evaluation.txt 
		...
		python -u main_evaluation.py "[DeepFool]" 	    > ../../evaluation_result/cifar10_CNN_evaluation.txt 
